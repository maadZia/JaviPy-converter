# Generated from ..//Desktop//javipy//javipyGrammar.g4 by ANTLR 4.13.1
from antlr4 import *
if "." in __name__:
...
class javipyGrammarListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by javipyGrammarParser#declaration.
    def enterDeclaration(self, ctx:javipyGrammarParser.DeclarationContext):
        pass

    # Exit a parse tree produced by javipyGrammarParser#declaration.
    def exitDeclaration(self, ctx:javipyGrammarParser.DeclarationContext):
        pass


    # Enter a parse tree produced by javipyGrammarParser#enum_declaration.
    def enterEnum_declaration(self, ctx:javipyGrammarParser.Enum_declarationContext):
        pass

    # Exit a parse tree produced by javipyGrammarParser#enum_declaration.
    def exitEnum_declaration(self, ctx:javipyGrammarParser.Enum_declarationContext):
        pass


    # Enter a parse tree produced by javipyGrammarParser#enum_body.
    def enterEnum_body(self, ctx:javipyGrammarParser.Enum_bodyContext):
        pass

    # Exit a parse tree produced by javipyGrammarParser#enum_body.
    def exitEnum_body(self, ctx:javipyGrammarParser.Enum_bodyContext):
        pass
    ...
    # Enter a parse tree produced by javipyGrammarParser#enum_object.
    def enterEnum_object(self, ctx:javipyGrammarParser.Enum_objectContext):
        pass

    # Exit a parse tree produced by javipyGrammarParser#enum_object.
    def exitEnum_object(self, ctx:javipyGrammarParser.Enum_objectContext):
        pass
    ...
    # Enter a parse tree produced by javipyGrammarParser#for_iteration.
    def enterFor_iteration(self, ctx:javipyGrammarParser.For_iterationContext):
        pass

    # Exit a parse tree produced by javipyGrammarParser#for_iteration.
    def exitFor_iteration(self, ctx:javipyGrammarParser.For_iterationContext):
        pass
